...
# 1. ENTITY DEFINITION
# ------------------------------------------------------------------
# This represents the primary key for your features.
machine = Entity(
    name="machine_id", 
...
# ------------------------------------------------------------------
# This points to the Parquet file generated by your feature_engineering.py
# ensuring the offline store uses the exact same data as your research.
...
# ------------------------------------------------------------------
# This registers all your engineering logic into the store.
machine_health_view = FeatureView(
    ...
    schema=[
        ...
        # --- 3. RAW SENSORS & COUNTERS (New Additions) ---
        # If your model uses the 'current' values alongside the 'rolling' ones, 
        ...
        # Assuming your locations are A, B, C, D based on previous outputs
